    ...
    def post(self):
        ...
        class counter(object):
            ...
            def first(self,keyword):
                cc=self.amnoxDB.book_dict.find()
                self.lock.acquire()
                for shit in cc:
            ...
            def second(self,keyword):
                ...
                cc=self.amnoxDB.college_dict.find()
                self.lock.acquire()
                for shit in cc:
            ...
            def third(self,keyword):
                ...
                cc=self.amnoxDB.cricket_dict.find()
                self.lock.acquire()
                for shit in cc:
            ...
            def fourth(self,keyword):
                ...
                cc=self.amnoxDB.football_dict.find()
                self.lock.acquire()
                for shit in cc:
            ...
            def fifth(self,keyword):
                ...
                cc=self.amnoxDB.movies_eng_dict.find()
                self.lock.acquire()
                for shit in cc:
            ...
            def sixth(self,keyword):
                ...
                cc=self.amnoxDB.movies_hin_dict.find()
                self.lock.acquire()
                for shit in cc:
            ...
            def eighth(self,keyword):
                ...
                cc=self.amnoxDB.tv_series_dict.find()
                cd=self.amnoxDB.top_pages_dict.find()
                self.lock.acquire()
                for shit in cc:
